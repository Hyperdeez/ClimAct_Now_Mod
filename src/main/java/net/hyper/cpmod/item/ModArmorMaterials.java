...
import static net.hyper.cpmod.item.ModItems.WATER_MAGIC;

public enum ModArmorMaterials implements ArmorMaterial{
    WATER("wat", 20,Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
        ...
        return Ingredient.of(WATER_MAGIC.get());
    });
