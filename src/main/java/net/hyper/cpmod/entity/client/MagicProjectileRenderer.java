package net.hyper.cpmod.entity.client;
...
public class MagicProjectileRenderer extends EntityRenderer<BasicMagicProjectileEntity> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CulMod.MOD_ID, "textures/entity/magic_projectile.png");
